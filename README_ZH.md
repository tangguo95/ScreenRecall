...
本项目 99% 以上的代码、文档与细节打磨均在作者主导与审阅下，借助 AI 编程工具（包括 OpenAI Codex）完成。

本项目按“现状”提供，主要用于学习、实验和个人使用。项目未经过专门的专业安全审计、漏洞扫描、隐私评估或合规性审查；如需用于生产环境、公开网络、隐私敏感或安全敏感场景，请先自行完成代码审查、测试与加固。因使用本项目造成的安全问题、隐私风险、数据丢失、服务中断或其他风险，作者不承担相关责任。
